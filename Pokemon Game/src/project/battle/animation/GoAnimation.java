...
public class GoAnimation extends BattleAnimation {
	...
	public void initialize(AssetManager assetManager, TweenManager tweenManager) {
		...
		Tween.to(this, BattleAnimationAccessor.PRIMARY_OFFSET_X, 0.8f).target(0f).start(tweenManager);
		Tween.to(this, BattleAnimationAccessor.PRIMARY_ALPHA, 0.8f).target(1f).start(tweenManager);
	}
