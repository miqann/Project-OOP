...
public class HPBar extends Widget {
	...
	public void draw(Batch batch, float parentAlpha) {
		...
		/* ACTUAL COLORED HP */
		hpColor.draw(batch, this.getX() + hp_left.getMinWidth() + padLeft, this.getY() + padBottom, hpWidth,
				(hp_bar.getMinHeight() - padTop - padBottom));

		/* HP BAR FRAME */
		hp_bar.draw(batch, this.getX() + hp_left.getMinWidth(), this.getY(), hp_bar.getMinWidth(),
				hp_bar.getMinHeight());
	}
