...
public class TextureAnimation {
	...
	/**
	 * Returns a {@link TextureRegion} based on the so called state time. This is
	 * the amount of seconds an object has spent in the state this Animation
	 ...
	 * Returns a {@link TextureRegion} based on the so called state time. This is
	 * the amount of seconds an object has spent in the state this Animation
	 * instance represents, e.g. running, jumping and so on using the mode specified
	 * by {@link #setPlayMode(PlayMode)} method.
	 * 
	 * @param stateTime
	 * @return the TextureRegion representing the frame of animation for the given
	 *         state time.
	...
	/**
	 * Returns the keyFrames[] array where all the TextureRegions of the animation
	 * are stored.
	 * 
