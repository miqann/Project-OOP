package project.pokemon.screen;
...
import project.pokemon.controller.ActorMovementController;
import project.pokemon.controller.DialogueController;
import project.pokemon.controller.InteractionController;
import project.pokemon.controller.OptionBoxController;
import project.pokemon.dialogue.Dialogue;
import project.pokemon.model.Camera;
import project.pokemon.model.DIRECTION;
import project.pokemon.model.actor.PlayerActor;
import project.pokemon.model.world.World;
import project.pokemon.model.world.cutscene.ActorWalkEvent;
import project.pokemon.model.world.cutscene.CutsceneEvent;
import project.pokemon.model.world.cutscene.CutscenePlayer;
import project.pokemon.screen.renderer.EventQueueRenderer;
import project.pokemon.screen.renderer.TileInfoRenderer;
import project.pokemon.screen.renderer.WorldRenderer;
import project.pokemon.screen.transition.FadeInTransition;
import project.pokemon.screen.transition.FadeOutTransition;
...
public class GameScreen extends AbstractScreen implements CutscenePlayer {
	...
	public GameScreen(PokemonGame app) {
		...
		AnimationSet animations = new AnimationSet(
				...
				atlas.findRegion("brendan_stand_north"), atlas.findRegion("brendan_stand_south"),
				atlas.findRegion("brendan_stand_east"), atlas.findRegion("brendan_stand_west"));
		animations.addBiking(new Animation(0.4f / 2f, atlas.findRegions("brendan_bike_north"), PlayMode.LOOP_PINGPONG),
		...
		animations.addRunning(new Animation(0.25f / 2f, atlas.findRegions("brendan_run_north"), PlayMode.LOOP_PINGPONG),
	...
	public void changeLocation(World newWorld, int x, int y, DIRECTION facing, Color color) {
		getApp().startTransition(this, this,
